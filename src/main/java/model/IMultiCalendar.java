...
/**
 * Interface for managing multiple calendars, including calendar creation,
 * selection, and cross-calendar event operations.
 */
public interface IMultiCalendar {
  ...
  /**
   * Copies an event from the current calendar to another calendar,
   * potentially with a different start time.
   *
